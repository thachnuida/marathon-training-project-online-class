...
urlpatterns = patterns('',
    ...
    url(r'^disable-class/(?P<class_id>\d+)$', disable_class, name='disableclass'),
    url(r'^(?P<pk>\d+)/student-class/$', student_class, name='studentclass'),
    ...
    url(r'^user/(?P<user_id>\d+)/process/$', student_process, name='studentprocess'),
    url(r'^user/(?P<user_id>\d+)/detail/$', student_detail, name='studentdetail'),
